        ...
        if (response.success && response.user) {
          ...
          if (emailCheck.data?.exists) {
            if (emailCheck.data.crossRoleConflict) {
              ...
              showError(`This email is already registered as a ${emailCheck.data.user.role}. Each email can only be used for one role. Please use a different email or login with the existing ${emailCheck.data.user.role} account.`)
              return
            }
            ...
            if (userData?.emailVerified) {
              ...
              showError("An account with this email already exists. Please login with your email and password instead.")
            } else {
              ...
              try {
                ...
                showError("An account with this email exists but is not verified. Please try logging in with your email and password.")
              } catch (updateError) {
                ...
                showError("An account with this email exists but is not verified. Please check your email for the verification code or try logging in with your email and password.")
              }
            }
            return
          }
          ...
          <div className={styles.formContainer}>
            <div className={styles.roleIndicator}>
              <div className={styles.roleInfo}>
                <div className={`${styles.roleIcon} ${styles.employer}`}>
                ...
                <div className={styles.inputGroup}>
                  ...
                  {isLogin && (
                    <div className={styles.forgotPasswordContainer}>
                      <Link to="/auth/forgot-password?from=employer" className={styles.forgotPasswordLink}>
                        Forgot Password?
                      </Link>
                    </div>
                  )}
