...
Python for Data Science | IBM (Coursera)                                        December 2023`,
    expected: { education: 1, experience: 0, projects: 4, certifications: 3 }
  }
};
...
async function testAllResumes() {
  ...
  try {
    console.log('🔄 Testing All Five Resume Formats...\n');
    ...
    if (validResults.length > 0) {
      ...
      console.log(`   Resumes Tested: ${validResults.length}/5`);
      ...
      console.log('   • Karl: Standard bullet format (student with certifications)');
...
testAllResumes().then(() => {
  console.log('\n🧪 Comprehensive Five-Resume Test Complete!');
}).catch(error => {
